...
SITE_URL = 'https://beingkid.org/donations/sponsorship-opportunities-for-classes-events/'  # الرابط الرئيسي
URL_AJAX = 'https://beingkid.org/wp-admin/admin-ajax.php'  # رابط الـ ajax
# ================================================================
